...
import { Sparkles, Phone, MapPin, Clock, CheckCircle2, ExternalLink, ShieldCheck } from 'lucide-react';
import { ScrollReveal } from './ScrollReveal';
import { COMPANY_INFO } from '../data/bootcampData';
import { CONSULTATION_URL, handlePhoneClick } from '../utils/consultation';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal direction="up" distance={30}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            {/* LEFT COLUMN: Catchy Banner Text & Contact Details (Area 2) */}
            <div className="w-full flex flex-col justify-center">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black text-black leading-[1.25] tracking-tight mb-6">
                망설이지 마세요.<br />
                국비교육 전문가가<br />
                친절하게 안내해드립니다.
              </h2>
            ...
            {/* RIGHT COLUMN: Consultation CTA Card (Area 1 placed on the right of Area 2) */}
            <div className="w-full flex justify-center md:justify-end">
              <div
                id="fast-inquiry-form"
                className="w-full bg-white text-gray-900 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl border-2 border-black/10 max-w-xl mx-auto md:mx-0 relative overflow-hidden transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.25)]"
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-4 sm:py-5 px-6 rounded-2xl bg-black hover:bg-gray-900 text-white font-black text-base sm:text-lg transition-all flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl active:scale-[0.99] group text-center cursor-pointer"
                >
